...
const config = {
    serverInfo: {
        ...
        serverIp: "mc.megufun.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
    ...
    */
    ...
    atGroupsDefaultColors: {
        creator: "rgba(255, 124, 124, 0.5)",
        members: "rgba(230, 83, 0, 0.5)",
    },
    adminTeamPage: {
        creator: [
            {
...
/*If you want to change website color go to /css/global.css and in :root {} is a color pallets (don't change names of variables, change only values)*/
