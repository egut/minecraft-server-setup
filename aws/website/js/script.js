...
const config = {
  serverInfo: {
    ...
    serverIp:
      "mc.hypixel.net" /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/,
    discordServerID:
      "489529070913060867" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/,
  },
